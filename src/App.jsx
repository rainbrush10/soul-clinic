  ...
  const getResultDetails = (category, energyType) => {
    const db = {
      ...
      'NT': {
        title: "NT 分析家",
        drinkName: "大腦過載水",
        ingredients: "Whisky Tea w/ Honey",
        traits: "行走的 CPU，用邏輯手術刀解剖不合理。討厭廢話與笨蛋。冷靜常被誤解為冷漠，其實只是懶得處理無效的情緒交流。",
        mechanism: "你需要效率。厚重酒精讓 CPU 降頻，茶葉單寧保持洞察。去除了所有花俏裝飾，直球對決，精準、高濃度、不囉唆。",
        tags: ["邏輯", "效率", "直球對決"],
